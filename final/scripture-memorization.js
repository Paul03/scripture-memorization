...
const button = document.querySelector('#RemoveWordButton');
...
function handleButtonClick(event) {
    ...
    const wordCountToRemoveElement = document.querySelector('#NumberOfWordsToRemove');
    const numberOfWordsToRemove = wordCountToRemoveElement.value;
